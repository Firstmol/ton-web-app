import { ContractProvider, Sender, SendMode, Contract, Cell, Address, beginCell, contractAddress } from 'ton-core';
...
export class MainContract implements Contract {
    ...
    async sendIncrement(provider: ContractProvider, sender: Sender, value: bigint, increment_by: number) {
        const mgs_body = beginCell().storeUint(1, 32).storeUint(increment_by, 32).endCell()
